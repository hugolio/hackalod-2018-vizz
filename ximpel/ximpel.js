...
// List of known events. Can be expanded by plugins.
ximpel.Player.prototype.events = [
    // Sent when player ends
    ximpel.Player.prototype.EVENT_PLAYER_END,

    // Sent when variable is updated
    ximpel.Player.prototype.EVENT_VARIABLE_UPDATED,

    // Sent on swipe
    ximpel.Player.prototype.EVENT_SWIPE,

    // Sent when a subject begins to play. The subject model is included as an argument.
    ximpel.Player.prototype.EVENT_SUBJECT_PLAYING,
];
...
ximpel.Player.prototype.addEventHandler = function( eventName, func ){
    ...
    return this.pubSub.subscribe( eventName, func );
}
